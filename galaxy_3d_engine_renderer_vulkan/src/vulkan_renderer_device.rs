/// VulkanRendererDevice - Vulkan implementation of RendererDevice trait

use galaxy_3d_engine::{
    RendererDevice, RendererCommandList, RendererRenderTarget, RendererRenderPass, RendererSwapchain,
...
pub struct VulkanRendererDevice {
    /// Vulkan entry
    _entry: ash::Entry,
    /// Vulkan instance
...
impl RendererDevice for VulkanRendererDevice {
...
impl Drop for VulkanRendererDevice {
    fn drop(&mut self) {
        unsafe {
